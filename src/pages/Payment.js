    ...
    return (
        ...
        <div className='container'>
            <div className='col-md-5 offset-md-3 p-3 mt-4 shadow-lg'>
                    ...
                    <h2 className='mb-3'>Card Inforomation</h2>
                    <div className='mb-3'>
                        <label htmlFor='card-number'>Card Number</label>
                        <CardNumberElement type="text" className='form-control'
                         id="card-number" options={options}/>
                    </div>
                    <div className='mb-3'>
                        <label htmlFor='card-expiry'>Card Expiry</label>
                        <CardExpiryElement type="text" className='form-control'
                         id="card-expiry" options={options}/>
                    </div>
                    <div className='mb-3'>
                        <label htmlFor='card-cvc'>Card CVC</label>
                        <CardCvcElement type="text" className='form-control'
                         id="card-cvc" options={options}/>
                    </div>
                    <div className='mb-3'>
