      ...
      <div className="container-fluid">
        <div className="row custom-header align-items-center">
          <div className="col-lg-3">
            <Link className="navbar-brand text-white" to="/">Yarsa</Link>
          </div>
          ...
          <div className="col-lg-3">
            <ul className="d-flex justify-content-evenly">
              ...
              {!isAuthenticated() && (
                <>
                  <li className="list-unstyled"><Link to="/signin"
                    className="text-decoration-none text-white fs-5">
                    <i className="bi bi-box-arrow-in-right fs-3"></i>Signin</Link></li>
                  <li className="list-unstyled"><Link to="/signup" className="text-decoration-none text-white fs-5">
                    <i className="bi bi-person-plus-fill fs-3"></i>Signup</Link></li>
                </>

              )}
              {
                isAuthenticated() && (
                  <button className='btn btn-outline-warning mt-2' onClick={() => signout(() => { navigate('/') })}>Signout</button>
                )
              }
